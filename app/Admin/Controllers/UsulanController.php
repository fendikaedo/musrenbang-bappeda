...
class UsulanController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('kelurahan_id', __('Kelurahan'));
        $grid->column('latitude', __('Latitude'));
        $grid->column('longitude', __('Longitude'));
        $grid->column('usulan_ke', __('Usulan ke'));
        $grid->column('opd_id_awal', __('OPD Tujuan Awal'));
        $grid->column('opd_id_akhir', __('OPD Tujuan Akhir'));
        $grid->column('status_id', __('Status'));
    ...
    protected function detail($id)
    {
        ...
        $show->field('kelurahan_id', __('Kelurahan'));
        $show->field('latitude', __('Latitude'));
        $show->field('longitude', __('Longitude'));
        $show->field('usulan_ke', __('Usulan ke'));
        $show->field('opd_id_awal', __('OPD Tujuan Awal'));
        $show->field('opd_id_akhir', __('OPD Tujuan Akhir'));
